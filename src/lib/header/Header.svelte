...
<header>
    <nav>
        <ul>
            ...
            <li class:active={$page.url.pathname === '/resume'} class="float-hover"><a sveltekit:prefetch href="/resume">Resume</a></li>
            <li class:active={$page.url.pathname === '/contact'} class="float-hover"><a sveltekit:prefetch href="/contact">Contact</a></li>
        </ul>
    </nav>
</header>
